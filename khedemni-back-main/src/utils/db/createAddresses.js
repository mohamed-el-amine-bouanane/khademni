...
const ALGERIA = {
  ...
  Illizi: {
    lng: "8.4829",
    lat: "26.5080",
    communes: ["Bordj Omar Driss", "Debdeb", "In Amenas", "Illizi"],
  },
  "Bordj Bou Arreridj": {
    lng: "4.7667",
    lat: "36.0667",
...
async function createAddresses() {
  for (wilaya in ALGERIA) {
    for (commune of ALGERIA[wilaya]["communes"]) {
      ...
      console.log(wilaya + " " + commune + "created successfully");
    }
  }
}
